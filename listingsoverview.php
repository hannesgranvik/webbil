...
<div class="container pt-5">
    <div class="row pb-2 border-bottom border-secondary mb-3 fw-bold">
        <div class="col">Annons id</div>
        <div class="col">Publiceringsdatum</div>
        <div class="col">Pris</div>
        <div class="col">Är aktiv?</div>
    ...
    <?php foreach ($listingSearch as $listing): ?>
        <div class="row py-2 align-items-center">
            <div class="col">
                <?php echo $listing['annons_id']; ?>
            </div>
            <div class="col">
                <?php echo $listing['publiceringsdatum']; ?>
            </div>
            <div class="col">
                <?php echo $listing['pris']; ?>
            </div>
            <div class="col text-truncate">
                <?php echo $listing['ar_aktiv'] ? "Ja" : "Nej"; ?>
            </div>
                ...
                <div class="modal-body text-start">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="pris" class="form-control" value="<?php echo htmlspecialchars($listing['pris'] ?? ''); ?>" required>
                        </div>

                        <div class="col-md-6 mb-3">
                            <label class="form-label">beskrivning</label>
                            <input type="text" name="beskrivning" class="form-control" value="<?php echo htmlspecialchars($listing['beskrivning'] ?? ''); ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="ar_aktiv" class="form-control" value="<?php echo htmlspecialchars($listing['ar_aktiv'] ?? ''); ?>">
                        </div>
                    </div>
                </div>
